...
The same composition mounts the local [Widgets provider](../../widget/widgets-local/README.md) on the Host and the [Widgets application](../../client/ui-widgets/README.md) in the browser roster.
