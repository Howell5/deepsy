...
import widgetsRemote from '@deepseek-ai/dsh-widgets-local/remote'
...
export type {
  WidgetId, WidgetLayoutItem, WidgetManifest as WidgetManifestView, WidgetSize,
  WidgetState, WidgetStateValue, WidgetView,
} from '@deepseek-ai/dsh-widgets/types'
export type {} from '@deepseek-ai/dsh-widgets-local/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      subagentsRemote, sessionRemote, workspaceRemote, widgetsRemote,
    ]) {
