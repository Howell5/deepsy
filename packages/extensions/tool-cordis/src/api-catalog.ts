...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'WidgetLayoutItem',
    declaration: 'export interface WidgetLayoutItem {\n    id: WidgetId;\n    size: WidgetSize;\n    column: number;\n    row: number;\n}',
  },
  {
    name: 'WidgetManifest',
    declaration: 'export interface WidgetManifest {\n    schemaVersion: 2;\n    id: WidgetId;\n    name: string;\n    version: string;\n    runtime: \'static\';\n    entry: string;\n    sizes: WidgetSize[];\n    defaultSize: WidgetSize;\n    permissions: {\n        network: string[];\n    };\n    refresh: {\n        mode: WidgetRefreshMode;\n        minimumIntervalSeconds: number;\n    };\n}',
  },
  {
    name: 'WidgetRefreshMode',
    declaration: 'export type WidgetRefreshMode = \'manual\' | \'on-open\' | \'visible-interval\';',
  },
  {
    name: 'WidgetSize',
    declaration: 'export type WidgetSize = \'small\' | \'medium\' | \'large\';',
  },
  {
    name: 'WidgetState',
    declaration: 'export type WidgetState = {\n    [key: string]: WidgetStateValue;\n};',
  },
  {
    name: 'WidgetStateValue',
    declaration: 'export type WidgetStateValue = null | boolean | number | string | WidgetStateValue[] | WidgetState;',
  },
  {
    name: 'WidgetView',
    declaration: 'export interface WidgetView {\n    manifest: WidgetManifest;\n    sourcePath: string;\n    builtIn: boolean;\n}',
  },
  {
