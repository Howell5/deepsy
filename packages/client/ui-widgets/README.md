...
- **One installed project is one canvas instance** — layout has no separate instance id, so duplicate cards, disable, remove UI, a standalone focused view, and settings are deferred.
