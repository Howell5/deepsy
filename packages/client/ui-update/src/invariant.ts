...
/**
 * No runtime invariant: the settings slot registration is an effect owned
 * and observed by the slot registry, and the update decision is exercised
 * through its unit and component tests.
 */
