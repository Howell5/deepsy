...
flowchart TD
  ...
  pkg_widgets_local --> pkg_typert_protocol
...
| [`client-ui-update`](../packages/client/ui-update) | `client` | — |
| [`client-ui-user-questions`](../packages/client/ui-user-questions) | `client` | — |
| [`client-ui-widgets`](../packages/client/ui-widgets) | `client` | — |
...
| [`widgets`](../packages/widget/widgets) | `widget` | [`brand`](../packages/util/brand) |
...
| [`widgets-local`](../packages/widget/widgets-local) | `widget` | [`typert-protocol`](../packages/typert/protocol), [`widgets`](../packages/widget/widgets) |
