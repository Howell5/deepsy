...
来源：[`packages/widget/widgets-local/src/index.ts:110`](../packages/widget/widgets-local/src/index.ts)
...
- `@deepseek-ai/dsh-widgets` — 抽象类 `Widgets` ([`packages/widget/widgets/src/index.ts`](../packages/widget/widgets/src/index.ts))
